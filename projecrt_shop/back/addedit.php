...
<head>
    ...
    <script>
        ...
        function dosome() {
            ...
            $.ajax({
                url: "./addedit/getproduct_content.php",
                type: "post",
                data: {
                    id: select
                },
            ...
            $.ajax({
                url: "./addedit/getproduct_type1.php",
                type: "post",
                data: {
                    id: select
                },
            ...
            $.ajax({
                url: "./addedit/getproduct_type2.php",
                type: "post",
                data: {
                    id: select
                },
            ...
            $.ajax({
                url: "./addedit/getproduct_type3.php",
                type: "post",
                data: {
                    id: select
                },
            ...
            $.ajax({
                url: "./addedit/getproduct_price.php",
                type: "post",
                data: {
                    id: select
                },
