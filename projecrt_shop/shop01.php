...
<body>
    ...
    ?>
                ...
                <div class="col-md-4" style="<?=$styledisplay?>">
                    <!-- <div onclick="window.location.href='shop-single.php?product_id=<?= $row['product_id'] ?>';"> -->
                    <div class="card mb-4 product-wap rounded-0">
                        ...
                        <div class="card-body">
                            <a href="shop-single.php?product_id=<?= $row['product_id'] ?>" class="h3 text-decoration-none"><?= $row['product_name'] ?></a>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    $("#product_area").html(response.product);
                    $("#product_pagebutton").html(response.pagebutton);
                },
            });
        });
    </script> -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            buttons.forEach(button => {
                ...
                button.addEventListener('click', function() {
                    ...
                    button.dataset.favorite = isFavorite.toString(); // 將已經更新的isFavorite用toString()的方式回丟給html
